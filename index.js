...
exports.plugin = function(schema, options) {
  ...
  var settings = {
      ...
      prefix: null, // custom text before the auto-increment count.
      suffix: null, // custom text after the auto-increment count.
      fieldType: 'Number', // default type should be 'Number'.
    },
